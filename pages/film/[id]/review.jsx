...
import ReviewFormBlock from '../../../components/_blocks/review-form-block/ReviewFormBlock'
import Sprite from '../../../components/sprite/Sprite'

const Review = () => {
  const { film, comments } = useSelector((state) => state.films)
  console.log('film', film, comments)
  return (<>
    <Head>
...
export const getServerSideProps = wrapper.getServerSideProps((store) => {
  return async (context) => {
    ...
    const responseComments = fetchFilmComments('GET', `https://9.react.pages.academy/wtw/comments/${context.query.id}`)
